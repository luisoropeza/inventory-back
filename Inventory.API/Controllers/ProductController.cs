...
namespace Inventory.API.Controllers
{
    ...
    public class ProductController(IProductService service) : ControllerBase
    {
        ...
        public async Task<IActionResult> BulkUploadProductsAsync(IFormFile file, [FromHeader][BindRequired] Guid businessId)
        {
            ...
            await service.BulkUploadProductsAsync(stream, businessId);
            return Ok();
        }
